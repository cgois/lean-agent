...
- Use `mathlib` and the [`QuantumInfo`](https://github.com/leanprover-community/physlib/tree/master/QuantumInfo) part of Physlib; only write new definitions, proofs and tactics if absolutely necessary.
