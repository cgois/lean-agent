...
- State the target theorem in `./LeanProof/LeanProof/Problem.lean` so that it matches `Formalization.md`.
- If the theorem in `./LeanProof/LeanProof/Problem.lean` does not yet match `Formalization.md`, stop and fix the mismatch before continuing.
- Before each substantial proof attempt, re-check that the theorem currently stated in `./LeanProof/LeanProof/Problem.lean` matches `Formalization.md`.
...
- After each substantial edit to `./LeanProof/LeanProof/Problem.lean`, run `cd LeanProof && lake build` or `bash ./scripts/build.sh`.
...
- Put the main theorem and all helper lemmas in `./LeanProof/LeanProof/Problem.lean` unless the user explicitly wants another structure.
...
- Prefer edits that keep `./LeanProof/LeanProof/Problem.lean` close to a compilable state.
...
- `./LeanProof/LeanProof/Problem.lean` contains no `sorry`, `admit`, or `axiom`.
- `Formalization.md` reflects the final theorem and final encoding choices actually used in `./LeanProof/LeanProof/Problem.lean`.
- The theorem in `./LeanProof/LeanProof/Problem.lean` matches `Formalization.md`.
